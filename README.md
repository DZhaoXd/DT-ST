...
This is a [pytorch](http://pytorch.org/) implementation of [DT-ST]([https://arxiv.org/abs/2007.09222](https://openaccess.thecvf.com/content/CVPR2023/html/Zhao_Towards_Better_Stability_and_Adaptability_Improve_Online_Self-Training_for_Model_CVPR_2023_paper.html)).
...
### Acknowledge
Some codes are adapted from [FADA]([https://github.com/facebookresearch/maskrcnn-benchmark](https://github.com/JDAI-CV/FADA#classes-matter-a-fine-grained-adversarial-approach-to-cross-domain-semantic-segmentation-eccv-2020)) and [DSU]([https://github.com/hszhao/semseg](https://github.com/lixiaotong97/DSU)). We thank them for their excellent projects.
